...
export const oktaAuthHandler = (req, res, next) => {
  ...
  getOktaTokens(code)
    .then((tokenData) => {
      ...
      return getOktaUserInfo(access_token);
    })
    .then((userData) => {
      newUserData = {
        email: userData.email,
        name: userData.name,
        picture: userData.picture || "", // Okta might not provide a picture
      };
...
export const loginValidation = async (req, res, next) => {
  try {
    ...
    const token = getCookieValue(cookieString, cookieName);
